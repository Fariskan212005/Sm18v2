...
auth_channel = environ.get('AUTH_CHANNEL', '-1001711888870')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Srilinks4k:Srilinks4k@cluster0.y9fsm46.mongodb.net/?retryWrites=true&w=majority")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>ɴᴀᴍᴇ</b> : <strong><code>{file_name}</code>\n\n<b>Share and support us ❤️ \n\n〽️ Powered By @Srilinks4k_In</strong></b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b>ɴᴀᴍᴇ</b> : <strong><code>{file_name}</code>\n\n<b>Share and support us ❤️ \n\n〽️ Powered By @Srilinks4k_In</strong></b>")
